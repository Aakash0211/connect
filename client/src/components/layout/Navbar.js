...
const Navbar = ({auth,logout}) => {
  const authLinks=(
    <ul>
      <li>
      <Link to ='/dashboard'><i className='fas fa-user'/>{' '}Dashboard</Link></li>
  <li ><Link to="/profiles"><i className='fas fa-users'></i>{' '}Users</Link></li>
 ...
 <nav className="navbar bg-dark">
      <h1>
    <Link to='/'><i className="fas fa-users"></i>{" "}Connect</Link>
      </h1>
